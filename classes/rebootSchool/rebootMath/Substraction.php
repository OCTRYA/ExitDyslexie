...
class Substraction implements \SingleExercise
{
    private $level;
    ...
    public function createRandomExercise($limitation){
        ...
        $secondValue = rand(0,$this->figure);
        $singleExercise = new Substraction();
    ...
    public function getSolution(){
        if(is_null($this->singleExercise)){
            ...
            return $this->figure - $this->singleExercise->getSolution();
        }
    }
