...
<div class="container-fluid">
 ...
 <div class="row">
 	<div class="col-lg-6">
        ...
        <tr><td>Geef het hoogste cijfer van de som op: </td><td><input type="text" name="heighestSumInput" id="heighestSumInput"/></td></tr>
        <tr><td>Optelling</td><td></td></tr>
        <tr><td>Aftrekking</td><td></td></tr>
        <tr><td>Vermenigvuldiging</td><td>Deling</td></tr>
        <tr><td>            
